...
const About = () => {
	return (
		<figure className="p-3 md:flex bg-gradient-to-r from-cyan-500 to-orange-100 pl-6 dark:from-slate-500 dark:to-teal-900 m-0">
			<img
				className="bg-slate-100 w-32 h-32 rounded-full m-auto"
				src={headshot}
				alt=""
			/>
			<div className="p-8 text-center md:text-left">
				<blockquote>
					<p className="text-md text-left font-medium overflow-scroll max-h-48 max-w-sm dark:text-slate-100 mb-2 pr-2">
						...
						comfortable working in stressful environments, have strong problem solving
						abilities and strive for the highest standards. I am enthusiastic about
						programming and find a real sense of self-gratification in tackling
